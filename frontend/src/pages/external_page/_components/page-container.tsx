          ...
          >
            <CardContent className="relative py-0 px-0">
              <a
                href="/"
                target="_blank"
                className="absolute -top-px z-50! right-[-5px] w-[100px] h-[100px] pointer-events-none will-change-transform overflow-hidden no-underline transition-all duration-100 ease-in"
              >
                <div

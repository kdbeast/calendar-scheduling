...
const BookingCalendar = ({
  ...
  return (
    <div className="relative lg:flex-[1_1_50%] w-full shrink-0 transition-all duration-220 ease-out p-4 pr-0">
      {/* Loader Overlay */}
      {isFetching && (
      ...
      <div className="flex flex-col h-full mx-auto pt-[25px]">
        ...
        <div className="w-full flex flex-col md:flex-row lg:flex-[1_1_300px]">
          ...
          {selectedDate && availability ? (
            <div className="w-full shrink-0 mt-3 lg:mt-0 max-w-xs md:max-w-[40%] pt-0 overflow-hidden md:ml-[-15px]">
